...
const FN_ARGS: Record<string, string[]> = {
  ...
  clear_system_halt: ['p_scope', 'p_reason_prefixes'],
  ...
  dash_today_overview: ['p_mode', 'p_champion'],
  ...
  dash_amsterdam_sim: [],
  city_sim_active_configs: [],
  city_sim_place_inputs: ['p_city_id', 'p_target', 'p_now'],
  city_sim_record: ['p_city_id', 'p_icao', 'p_unit', 'p_rows'],
  city_sim_grade_inputs: [],
  city_sim_settle: ['p_settlements'],
  dash_city_sim: [],
  // 0085 CITY-LIVE: the per-city Live toggle + maker-twin + promotion-board RPCs (staged dark).
  city_live_arms_get: [],
  city_live_arm_set: ['p_city_id', 'p_enabled', 'p_stake_usd', 'p_entry_hour'],
  city_live_runner_inputs: [],
  city_sim_bets_for_promotion: [],
  city_promotion_record: ['p_view'],
  dash_city_live: [],
  city_maker_twin_place: ['p_city_id', 'p_rows'],
  city_maker_twin_detect_fills: [],
  city_maker_twin_grade: [],
